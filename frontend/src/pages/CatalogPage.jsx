        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" }}>
          ...
          {filters.category !== "All Goods" && (
            <span style={{ display: "inline-flex", alignItems: "center", padding: "0.3rem 0.8rem", backgroundColor: "rgba(30, 58, 138, 0.05)", border: "1px solid rgba(30, 58, 138, 0.1)", borderRadius: "6px", fontSize: "0.75rem", fontWeight: "600", color: "var(--brand-blue)" }}>
              {filters.category} <span onClick={() => updateFilter("category", "All Goods")} style={{ marginLeft: "0.5rem", cursor: "pointer", fontSize: "0.8rem" }}>✕</span>
            </span>
          )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
          <div style={{ textAlign: "center", padding: "4rem 2rem", backgroundColor: "var(--bg-panel)", borderRadius: "12px", border: "1px solid var(--border)" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "1rem" }}>
              <button onClick={() => resetFilters()} style={{ padding: "0.8rem 1.5rem", backgroundColor: "var(--brand-blue)", color: "white", border: "none", borderRadius: "8px", cursor: "pointer", fontWeight: "600" }}>Reset All Filters</button>
            </div>
          </div>
          
          <div>
            <h3 style={{ fontSize: "1.3rem", fontWeight: "800", color: "var(--text-primary)", marginBottom: "1.5rem", borderBottom: "1px solid var(--border)", paddingBottom: "0.5rem" }}>You Might Also Like</h3>
            <div className="product-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: "2rem", marginBottom: "4rem" }}>
